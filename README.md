...
I like building practical software that has a real workflow behind it: npm packages, developer tools, local-first automation systems, web apps, security-focused CLIs, and research-style prototypes.

My recent work focuses heavily on **developer tooling**, **web security**, and **structured AI-assisted engineering workflows**.

* Building: `next-secure-check`, `Codex Engineering Workflow Pack`, `Pagonic`, `Nihongo Learn`, and my portfolio
* Learning: SQL, algorithms and data structures, debugging, testing, code reading, documentation, and software architecture
* Interested in: open-source developer tools, practical software projects, AI-assisted engineering workflows, security-focused tooling, and research-style prototypes
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        Open-source CLI for deterministic security sanity checks in Next.js projects before PR/deploy.
      </p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p><b>Focus:</b> developer tooling, local-first workflow design, policy guardrails, worker/reviewer flows, adapter foundation, CLI UX</p>
      <p><b>Status:</b> <code>v0.3.0-beta.0</code> published on npm · Coordinator Mode runtime · adapter foundation</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        The main idea is simple: inspect archives before extracting them. Pagonic focuses on deterministic risk signals, safer extraction gates, and a clearer Safe ZIP Inspector direction.
      </p>
      <p><b>Stack:</b> Python, ZIP tooling, CLI, pytest, optional PyQt6 GUI</p>
      <p><b>Focus:</b> safe archive inspection, ZIP risk signals, safe extraction, CLI workflows, release hardening</p>
    ...
    <td width="50%" valign="top">
      ...
      <p>
        Personal portfolio site built to present my projects, learning path, technical direction, and public work.
      </p>
      <p><b>Stack:</b> Next.js, TypeScript, Tailwind CSS, Framer Motion</p>
      <p><b>Focus:</b> personal branding, project presentation, responsive UI, animation, CV/profile alignment</p>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><b>Focus:</b> PDB parsing, Normal Mode Analysis, cavity scoring, CLI/API workflow</p>
      <p>
...
* **next-secure-check:** deterministic Next.js security checks, false-positive reduction, SARIF output, CLI reliability, and regression fixtures
* **Codex Engineering Workflow Pack:** local-first Codex skills, Coordinator Mode runtime, policy guardrails, reviewer gates, adapter foundation, and multi-worker workflow experiments
* **Pagonic:** Safe ZIP Inspector direction, archive risk signals, safe extraction behavior, docs, and release hardening
* **Portfolio/Profile alignment:** keeping my public projects, README files, portfolio site, and technical profile consistent
...
**Tools and platforms:** npm package publishing · GitHub Actions · SARIF · Git worktree · CLI development · Windows/PowerShell · Linux validation · Vitest · pytest

**Touched in projects:** FastAPI · Supabase · Oracle Cloud · PM2/Nginx · Docker basics · Tailwind CSS · Biopython/ProDy · PyQt6 basics
...
I am open to technical feedback, issue reports, open-source collaboration, project discussions, and practical developer-tooling ideas.
...
* Email: [removed@localhost](mailto:removed@localhost)
