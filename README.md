...
<p>
  <a href="https://linkedin.com/in/tuncayolmez">
    <img src="https://cdn.simpleicons.org/linkedin/0A66C2" height="28" alt="LinkedIn" title="LinkedIn" />
  </a>
  &nbsp;&nbsp;&nbsp;
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <br /><br />
      <strong>Release:</strong> <code>v0.6.0</code> · <code>25 rules</code> · <code>600 tests</code><br />
...
Alongside my public projects, I maintain several private systems where the
engineering work is intentionally kept out of the public repository surface.

| Project       | Focus                                                                                                                                                                 | State                          |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| **RedNode**   | Local-first, AI-assisted security workstation for authorized engagements with explicit scope, policy, execution, evidence, and verification boundaries.               | `private development`          |
| **HuntForge** | Codex-first workspace for authorized web/API security research and bug-bounty workflows, from scope and approval through evidence, triage, retest, and reporting.     | `private development`          |
| **BorsaLab**  | Local-first BIST research workstation for explainable screening, reproducible backtesting, strategy research, portfolio discipline, events, and fundamental analysis. | `private research workstation` |
| **BioVoid**   | Computational research prototype for reproducible full-heavy-atom protein-structure analysis and geometry-based pocket-candidate generation.                          | `private research prototype`   |
...
Its outputs are not clinical or diagnostic results, validated binding
predictions, drug-development results, or drug-discovery claims. Source,
datasets, and intermediate research artifacts remain private while the research
and independent review process continues.
...
<strong>Runtime & application stack</strong>
...
<strong>Engineering tooling</strong>
